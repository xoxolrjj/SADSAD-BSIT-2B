...
query <- "INSERT INTO movieDATABASE (Title, Reviewer, date_of_review, Rating, title_of_review, Review) 
VALUES 
('Phantom Thread',
 'AlsExGal',
 '18 December 2019',
...
query <- "INSERT INTO movieDATABASE (Title, Reviewer, date_of_review, Rating, title_of_review, Review) VALUES
                                                      ('Phantom Thread',
                                                       ...
                                                       '19 November 2022',
                                                       '6/10',
                                                       'Exquisitely crafted, ruined when it turns incoherent',
...
query <- "INSERT INTO movieDATABASE (Title, Reviewer, date_of_review, Rating, title_of_review, Review) VALUES
                                                      ('Phantom Thread',
                                                       ...
                                                       '1/10',
                                                       'Khan Review',
                                                       'Bad very very bad boring slow pathetic irritating. I wasted my precious twenty minutes and later fast forwarded till end just to see what type of nerds can like such movie and who are those morons who nominates such movies for award. Disgustingly bad useless nonsense.'
...
query<-            "INSERT INTO movieDATABASE (Title, Reviewer, date_of_review, Rating, title_of_review, Review) VALUES
                                                       ('Phantom Thread',
                                                        ...
                                                        '1/10',
                                                        'GID THIS IS AWFUL!',
                                                        'Please dont waste your time! Dreary, dreary and dreary!'
...
review_data <- dbGetQuery(connection, "SELECT * FROM sample_db.movieDATABASE")
glimpse(review_data)
View(review_data)

write.csv(review_data, file = "MovieReviews_DATA.csv")
